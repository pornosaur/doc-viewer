...
ToolBoxPageArea::ToolBoxPageArea(QWidget *parent, Qt::WindowFlags f) : QWidget(parent, f) {
    ...
    form_layout_area->setHorizontalSpacing(1);
    ...
    line_edit_type = new QLineEdit(this);
    line_edit_type->setObjectName(QStringLiteral("line_edit_type"));
    line_edit_type->setMinimumSize(QSize(42, 20));
    line_edit_type->setMaximumSize(QSize(16777215, 20));
    line_edit_type->setFont(font4);

    form_layout_area->setWidget(1, QFormLayout::FieldRole, line_edit_type);
    ...
    line_edit_action = new QLineEdit(this);
    line_edit_action->setObjectName(QStringLiteral("line_edit_action"));
    line_edit_action->setMinimumSize(QSize(42, 20));
    line_edit_action->setMaximumSize(QSize(16777215, 20));
    line_edit_action->setFont(font4);

    form_layout_area->setWidget(2, QFormLayout::FieldRole, line_edit_action);

    label_page = new QLabel(this);
    label_page->setObjectName(QStringLiteral("label_page"));
    label_page->setFont(font4);

    form_layout_area->setWidget(3, QFormLayout::LabelRole, label_page);
    ...
    form_layout_area->setWidget(3, QFormLayout::FieldRole, label_page_num);
    ...
    form_layout_area->setWidget(4, QFormLayout::SpanningRole, line_separator);

    label_x = new QLabel(this);
    label_x->setObjectName(QStringLiteral("label_x"));
    label_x->setFont(font4);

    form_layout_area->setWidget(5, QFormLayout::LabelRole, label_x);
    ...
    form_layout_area->setWidget(5, QFormLayout::FieldRole, line_edit_x);

    label_y = new QLabel(this);
    label_y->setObjectName(QStringLiteral("label_y"));
    label_y->setFont(font4);

    form_layout_area->setWidget(6, QFormLayout::LabelRole, label_y);
    ...
    form_layout_area->setWidget(6, QFormLayout::FieldRole, line_edit_y);

    label_width = new QLabel(this);
    label_width->setObjectName(QStringLiteral("label_width"));
    label_width->setFont(font4);

    form_layout_area->setWidget(7, QFormLayout::LabelRole, label_width);
    ...
    form_layout_area->setWidget(7, QFormLayout::FieldRole, line_edit_width);

    label_height = new QLabel(this);
    label_height->setObjectName(QStringLiteral("label_height"));
    label_height->setFont(font4);

    form_layout_area->setWidget(8, QFormLayout::LabelRole, label_height);
    ...
    form_layout_area->setWidget(8, QFormLayout::FieldRole, line_edit_height);
...
#ifndef QT_NO_TOOLTIP
    line_edit_type->setToolTip(QApplication::translate("MainWindow", "Area type", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    label_action->setText(QApplication::translate("MainWindow", "Action:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
    line_edit_action->setToolTip(QApplication::translate("MainWindow", "Area actions", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    line_edit_action->setText(QString());
